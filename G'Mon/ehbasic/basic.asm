...
LAB_BAER
	.word	ERR_SN		;$00 NEXT without FOR
	.word	ERR_SN		;$02 syntax
	.word	ERR_SN		;$04 RETURN without GOSUB
...
ERR_OD	.byte	"?Data",$00
ERR_FC	.byte	"?Function",$00
ERR_OV	.byte	"?Overflow",$00
ERR_OM	.byte	"?Out of Memory",$00
ERR_US	.byte	"?Gosub",$00
ERR_BS	.byte	"?Array",$00
ERR_D0	.byte	"?Zero",$00
ERR_ID	.byte	"?Illegal Direct",$00
ERR_TM	.byte	"?Type",$00
ERR_LS	.byte	"?String",$00
ERR_CN	.byte	"?Hault",$00
ERR_UF	.byte	"?Null Function",$00
...
LAB_BMSG	.byte	$0D,$0A,"Break",$0D,$0A,$00
LAB_EMSG	.byte	" Error",$0D,$0A,$00
LAB_LMSG	.byte	" in line ",$00
LAB_RMSG	.byte	"Ready",$0D,$0A,$00					; $0D,$0A,"Ready",$0D,$0A,$00
